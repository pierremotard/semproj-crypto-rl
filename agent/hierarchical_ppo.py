...
class Actor(nn.Module):
    ...
    def act(self, state):
        # print("State shape in act : {}".format(state.shape))
        ...
        # print("State with amount shape input to bid network : {}".format(state_with_amount.shape))

        out_bid_net = self.bid_net(state_with_amount)

        # print("Bid network output shape : {}".format(out_bid_net.shape))
